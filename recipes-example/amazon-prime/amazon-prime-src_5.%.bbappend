...
#SRC_URI += "${CMF_GIT_ROOT}/apps/amazon/AVPK5;protocol=${CMF_GIT_PROTOCOL};branch=rdk-next"
...
#EXTRA_OECMAKE += " -DBUILD_RUBY_PLAYER=ON"
#EXTRA_OECMAKE += " -DDEVICE_LAYER_CMAKE_ARGS="-DUSE_DUMMY_DRM=ON""

#EXTRA_OECMAKE += " -DAVPK_TV_PLATFORM=ON"
#EXTRA_OECMAKE += " -DDEVICE_LAYER_CMAKE_ARGS="-DAVPK_TV_PLATFORM=ON""
