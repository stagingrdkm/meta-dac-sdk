...
EXTRA_OEMAKE+= "BCM_AUDIODECODER=rialtowebaudiosink"
EXTRA_OEMAKE+= "BCM_BUFFERUNDERFLOW_SIGNAL=buffer-underflow-callback"
EXTRA_OEMAKE+= "BCM_VIRTUALDISPLAY_HEIGHT=1080"
EXTRA_OEMAKE+= "BCM_VIRTUALDISPLAY_WIDTH=1920"

SRC_URI += "file://0013-enable-link-gstapp.patch;patchdir=${WORKDIR}/git"
